          ...
          >
            <div>
              ...
              <p className="text-gray-700 mb-4 leading-relaxed">
                Snehankur was founded in 2008 with a vision to provide a
                nurturing environment for children who lack proper care and
                support. What began as a small initiative with just 5 children
                has now grown into a comprehensive support system helping
                hundreds annually.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Our founders recognized the need for not just physical care, but
                emotional and educational support that would empower these
                children to build better futures for themselves.
              </p>
            </div>
            <motion.div
